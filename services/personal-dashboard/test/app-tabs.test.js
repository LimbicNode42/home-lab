...
test('dashboard shell exposes seven accessible hash-backed tabs', () => {
...
test('dashboard panels are grouped into overview, work, knowledge, reports, investment screener, diary, and goals homes', () => {
  ...
  assert.match(indexSource, /id="panel-investment-screener"[\s\S]*id="investment-screener-panel"[\s\S]*id="panel-diary"/);

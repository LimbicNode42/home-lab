...
| LSE and TSE/JPX universe source and identity rules | Canonical LSE issuer and TSE/JPX listed-equity source contracts, provider symbol caveats, staged smoke/full hydration gates, and dashboard freshness requirements. | Add UK/Japan markets without pretending unmapped issuers or unverified provider suffixes are full coverage. | [LSE and TSE/JPX universe source and identity rules](./lse-tse-universe-source-and-identity-rules.md) |

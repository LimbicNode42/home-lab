...
Source evidence:
- archive `utils/init.sh` plus `/mnt/nas/services/portainer` metadata
...
- Docker socket mount gives administrator-level control over the Docker host; review before apply.

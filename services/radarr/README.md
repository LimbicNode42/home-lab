...
Source evidence:
- archive `utils/arr/init.sh` plus `/mnt/nas/services/radarr` metadata
...
- Candidate corrects archived `/opt/sonarr/config` reuse to the observed radarr NAS directory.
